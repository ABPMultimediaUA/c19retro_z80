...
Hexadecimal [16-Bits]
   ...
   4100 CD 13 46      [17]   50    call  cpct_disableFirmware_asm     
                             51    
   4103 CD 09 43      [17]   52    call  man_game_init
                             53 ;; Loop forever
   4106                      54 loop:
   4106 CD 16 43      [17]   55    call  man_game_update
                             56    
                             57    .rept 3
                             ...
                             60       halt
                             61    .endm
   4109 CD 0B 46      [17]    1       call  cpct_waitVSYNC_asm   
   410C 76            [ 4]    2       halt
   410D 76            [ 4]    3       halt
   410E CD 0B 46      [17]    1       call  cpct_waitVSYNC_asm   
   4111 76            [ 4]    2       halt
   4112 76            [ 4]    3       halt
   4113 CD 0B 46      [17]    1       call  cpct_waitVSYNC_asm   
   4116 76            [ 4]    2       halt
   4117 76            [ 4]    3       halt
                             62 
   4118 18 EC         [12]   63    jr    loop   
