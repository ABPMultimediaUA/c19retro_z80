...
Hexadecimal [16-Bits]
   ...
   4100 CD EA 45      [17]   54    call cpct_disableFirmware_asm     
                             55 
                             56    ;;call  man_entity_init
   4103 CD 56 44      [17]   57    call  man_entity_init   
   4106 CD 99 41      [17]   58    call  sys_input_init
   4109 CD 7D 41      [17]   59    call  sys_physics_init
   410C CD 6C 42      [17]   60    call  sys_render_init  
                             61 
   410F CD 07 43      [17]   62    call  sys_render_map 
                             63    
                             64 
                             65 ;; Loop forever
   4112                      66 loop:
                             67 
   4112 CD A1 41      [17]   68    call  sys_input_update
   4115 CD 8F 41      [17]   69    call  sys_physics_update
   4118 CD 60 44      [17]   70    call  man_entity_update
   411B CD 8A 42      [17]   71    call  sys_render_update
                             72    
                             73    .rept 4
                             74       call  cpct_waitVSYNC_asm   
                             75       halt
                             76       halt
                             77    .endm
   411E CD E2 45      [17]    1       call  cpct_waitVSYNC_asm   
   4121 76            [ 4]    2       halt
   4122 76            [ 4]    3       halt
   4123 CD E2 45      [17]    1       call  cpct_waitVSYNC_asm   
...
Hexadecimal [16-Bits]
   ...
   4126 76            [ 4]    2       halt
   4127 76            [ 4]    3       halt
   4128 CD E2 45      [17]    1       call  cpct_waitVSYNC_asm   
   412B 76            [ 4]    2       halt
   412C 76            [ 4]    3       halt
   412D CD E2 45      [17]    1       call  cpct_waitVSYNC_asm   
   4130 76            [ 4]    2       halt
   4131 76            [ 4]    3       halt
                             78 
   4132 18 DE         [12]   79    jr    loop   
